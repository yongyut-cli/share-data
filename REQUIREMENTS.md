...
**Phase 1 — MVP เทคนิค (สัปดาห์ 1–2)**
- pipeline EOD + อินดิเคเตอร์ + scoring เทคนิคล้วน + เก็บ SQLite/JSON
- เว็บ: dashboard + หน้ารายตัว + กราฟแท่งเทียน + screener พื้นฐาน
- **ส่งมอบได้: "ซื้อวันนี้ / ขายเมื่อไหร่" แบบเทคนิค**
